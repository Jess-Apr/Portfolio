...
export const skillsText: skillsTextItem[] = [
    {
        name: "Javascript",
        icon: "/assets/icons/ic_skills_javascript.svg",
        desc: [
    ...
    {
        name: "TypeScript",
        icon: "/assets/icons/ic_skills_typescript.svg",
        desc: [
    ...
    {
        name: "React",
        icon: "/assets/icons/ic_skills_react.svg",
        desc: [
    ...
    {
        name: "React Native",
        icon: "/assets/icons/ic_skills_react-native.svg",
        desc: [
    ...
    {
        name: "Redux",
        icon: "/assets/icons/ic_skills_redux.svg",
        desc: [
    ...
    {
        name: "Jotai / Recoil",
        icon: "/assets/icons/ic_skills_jotai.svg",
        desc: [
    ...
    {
        name: "React Query",
        icon: "/assets/icons/ic_skills_react-query.svg",
        desc: [
    ...
    },
    {
        ...
        icon: "/assets/icons/ic_skills_styled-components.svg",
        desc: [
    ...
    {
        name: "Tailwind CSS",
        icon: "/assets/icons/ic_skills_tailwind-css.svg",
        desc: [
