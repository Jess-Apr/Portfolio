...
export const skillsText: skillsTextItem[] = [
    {
        name: "Javascript",
        icon: "/icons/ic_skills_javascript.svg",
        desc: [
    ...
    {
        name: "TypeScript",
        icon: "/icons/ic_skills_typescript.svg",
        desc: [
    ...
    {
        name: "React",
        icon: "/icons/ic_skills_react.svg",
        desc: [
    ...
    {
        name: "React Native",
        icon: "/icons/ic_skills_react-native.svg",
        desc: [
    ...
    {
        name: "Redux",
        icon: "/icons/ic_skills_redux.svg",
        desc: [
    ...
    {
        name: "Jotai / Recoil",
        icon: "/icons/ic_skills_jotai.svg",
        desc: [
    ...
    {
        name: "React Query",
        icon: "/icons/ic_skills_react-query.svg",
        desc: [
    ...
    },
    {
        ...
        icon: "/icons/ic_skills_styled-components.svg",
        desc: [
    ...
    {
        name: "Tailwind CSS",
        icon: "/icons/ic_skills_tailwind-css.svg",
        desc: [
